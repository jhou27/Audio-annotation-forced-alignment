...
tg.path3$ = dir$ + "/" + filename3$ + ".TextGrid"
Read from file... 'tg.path3$'
Set tier name: 1, "CHI"
Insert interval tier: 2, "WORD-Ortho-2"
Insert interval tier: 2, "WORD-Jyutping-2"
Insert interval tier: 2, "WORD-CitIPA-2"
Insert interval tier: 2, "WORD-ActIPA-2"
Insert interval tier: 2, "SYLL-Ortho-2"
Insert interval tier: 2, "SYLL-Jyutping-2"
Insert interval tier: 2, "SYLL-CitIPA-2"
Insert interval tier: 2, "SYLL-ActIPA-2"
Insert interval tier: 2, "PHON-Phoneme-2"
select TextGrid 'filename.new$'
plus TextGrid 'filename3$'
Merge
